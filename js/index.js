var todoItems = [];
todoItems.push({ index: 1, value: "T-series", done: false });
todoItems.push({ index: 2, value: "Technical Guruji", done: false });
...
class TodoListItem extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      React.createElement("button", { type: "button", className: "close", onClick: this.onClickClose }, "Unsubscribe"))));
...
class TodoForm extends React.Component {
  ...
  render() {
    return (
      ...
      React.createElement("input", { type: "text", ref: "itemName", className: "form-control", placeholder: "Subscriber Channel Name..." }),
      React.createElement("button", { type: "submit", className: "btn btn-danger" }, "Subscribe")));
...
class TodoHeader extends React.Component {
  render() {
    return React.createElement("h1", null, "Subscription list");
  }}
